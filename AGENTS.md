...
Entry point: `.Codex/skills/SKILL.md`
...
Rules (always-on constraints): `.Codex/rules/`
...
**Skills**: `.Codex/skills/` | **Rules**: `.Codex/rules/` | **Commands**: `.Codex/commands/` | **Agents**: `.Codex/agents/`
